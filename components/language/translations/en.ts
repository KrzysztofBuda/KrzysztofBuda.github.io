...
mobileWaiter: {
  ...
  description:
    "An actively developed mobile hospitality system consisting of an Android application and a local REST API server that integrates mobile devices with an existing POS system and a Firebird database.",
  ...
  architecture: {
    ...
    description:
      "The system consists of a native Android application and a local backend. Static data is streamed using NDJSON and stored locally in Room, while the current state of tables and bills is maintained through Dynamic Runtime. The backend handles integration with the Firebird database used by the POS system, authentication, permissions and business logic.",
  ...
  description:
    "Static data is synchronized periodically, but the state of tables and bills changes continuously. Dynamic Runtime maintains their current versioned snapshot, retrieves changes from the server and allows the effects of completed operations to be applied immediately without waiting for the next synchronization cycle.",
  ...
  currentState: {
    ...
    items: [
      "User login with a PIN, a JWT-based session and device identification using a persistent UUID.",
      "Safe synchronization of static data to Room using NDJSON streaming, staging, validation and atomic snapshot activation.",
      "Dynamic Runtime maintaining the current state of tables and bills while automatically retrieving changes from the server.",
      "Room selection and physical table layout together with bill creation and editing, customer assignment, notes, comments and order items.",
      "Bill ownership handling, station assignment and controlled takeover of bills owned by another user.",
      "Local drafts, a persistent outbox, safe retries and conflict detection between local state and changes made on other devices.",
      "Moving and merging bills with revision control, permissions, recovery and immediate Runtime state updates.",
    ],
  },
  ...
  highlights: {
    ...
    items: [
      "Two-layer synchronization: versioned static-data snapshots together with Dynamic Runtime for the current state of tables and bills.",
      "Safe Room snapshot activation — a failed synchronization never replaces the last valid dataset.",
      "Persistent local drafts and outboxes allowing work to continue after an application restart or connection loss.",
      "Idempotent operations using persistent request IDs so retries after a timeout do not execute the same operation twice.",
      "Concurrency control based on bill revisions together with three-way diff handling for local and server-side conflicts.",
      "Moving and merging bills with recovery, permission and ownership checks, and immediate runtime_effect updates.",
    ],
  },
  ...
  roadmap: {
    ...
    items: [
      "Complete real-world testing of bill merging across multiple devices and connection-loss scenarios.",
      "Add trial bill support together with server-side printing and Runtime updates.",
      "Implement percentage and fixed-amount discounts for individual items and entire bills together with user limits and permissions.",
      "Implement bill settlement with payment-method selection, fiscal printing and correct bill finalization.",
      "Add bill transfer and bill splitting with permission and conflict handling.",
      "Complete multi-device testing, connect automatic logout after bill completion and finish system documentation.",
    ],
  },
  ...
  gallery: {
    ...
    description:
      "The application interface covers both configuration and everyday POS workflows — from login and settings to table selection, bill handling and operations performed on bills.",

    featuredAlt:
      "Mobile Waiter — room and table layout",
    ...
    connectionAlt:
      "Mobile Waiter — server connection configuration",
    ...
    orderAlt:
      "Mobile Waiter — open bill with items, customer and local changes",

    operationsAlt:
      "Mobile Waiter — bill operations menu",
  },  
},
